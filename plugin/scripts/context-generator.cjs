...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),m=_?`${_[1].split("/").pop()}:${_[2]}`:"unknown",E={...s,location:m};return this.warn(e,`[HAPPY-PATH] ${t}`,E,n),o}},u=new ee;var Bt={};function jt(){return typeof __dirname<"u"?__dirname:(0,f.dirname)((0,Ne.fileURLToPath)(Bt.url))}var Xt=jt();function Ht(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,f.join)((0,te.homedir)(),".claude-mem"),e=(0,f.join)(r,"settings.json");try{if((0,v.existsSync)(e)){let t=JSON.parse((0,v.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return s.CLAUDE_MEM_DATA_DIR}}catch{}return r}function se(){return Ht()}function re(){return(0,f.join)(se(),"settings.json")}function ne(){return(0,f.join)(se(),"claude-mem.db")}var L=se(),D=process.env.CLAUDE_CONFIG_DIR||(0,f.join)((0,te.homedir)(),".claude"),ps=(0,f.join)(D,"plugins","marketplaces","remote1993"),Es=(0,f.join)(L,"archives"),gs=(0,f.join)(L,"logs"),Ts=(0,f.join)(L,"trash"),fs=(0,f.join)(L,"backups"),Ss=(0,f.join)(L,"modes"),bs=re(),hs=ne(),Os=(0,f.join)(L,"vector-db"),Gt=(0,f.join)(L,"observer-sessions"),oe=(0,f.basename)(Gt),As=(0,f.join)(D,"settings.json"),Rs=(0,f.join)(D,"commands"),Cs=(0,f.join)(D,"CLAUDE.md");function Ie(r){(0,v.mkdirSync)(r,{recursive:!0})}function Le(){return(0,f.join)(Xt,"..")}var xe=require("crypto");var ve=require("os"),De=x(require("path"),1);var H=require("fs"),X=x(require("path"),1);var U={isWorktree:!1,worktreeName:null,parentRepoPath:null,parentProjectName:null};function ye(r){let e=X.default.join(r,".git"),t;try{t=(0,H.statSync)(e)}catch(m){return m instanceof Error&&m.code!=="ENOENT"&&u.warn("SYSTEM","Unexpected error checking .git for worktree detection",{cwd:r,error:m.message}),U}if(!t.isFile())return U;let s;try{s=(0,H.readFileSync)(e,"utf-8").trim()}catch(m){return u.warn("SYSTEM","Failed to read .git file during worktree detection",{cwd:r,error:m instanceof Error?m.message:String(m)}),U}let n=s.match(/^gitdir:\s*(.+)$/);if(!n)return U;let i=n[1].match(/^(.+)[/\\]\.git[/\\]worktrees[/\\]([^/\\]+)$/);if(!i)return U;let a=i[1],d=X.default.basename(r),_=X.default.basename(a);return{isWorktree:!0,worktreeName:d,parentRepoPath:a,parentProjectName:_}}function Me(r){return r==="~"||r.startsWith("~/")?r.replace(/^~/,(0,ve.homedir)()):r}function Wt(r){if(!r||r.trim()==="")return u.warn("PROJECT_NAME","Empty cwd provided, using fallback",{cwd:r}),"unknown-project";let e=Me(r),t=De.default.basename(e);if(t===""){if(process.platform==="win32"){let n=r.match(/^([A-Z]):\\/i);if(n){let i=`drive-${n[1].toUpperCase()}`;return u.info("PROJECT_NAME","Drive root detected",{cwd:r,projectName:i}),i}}return u.warn("PROJECT_NAME","Root directory detected, using fallback",{cwd:r}),"unknown-project"}return t}function ie(r){let e=Wt(r);if(!r)return{primary:e,parent:null,isWorktree:!1,allProjects:[e]};let t=Me(r),s=ye(t);if(s.isWorktree&&s.parentProjectName){let n=`${s.parentProjectName}/${e}`;return{primary:n,parent:s.parentProjectName,isWorktree:!0,allProjects:[s.parentProjectName,n]}}return{primary:e,parent:null,isWorktree:!1,allProjects:[e]}}var qt=3e4;function G(r,e,t){return(0,xe.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function B(r,e,t){let s=t-qt;return r.prepare("SELECT id, created_at_epoch FROM observations WHERE content_hash = ? AND created_at_epoch > ?").get(e,s)}function ae(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var O="claude";function Vt(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function M(r){if(!r)return O;let e=Vt(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("claude")?"claude":e:O}function Ue(r){let e=["claude","codex"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function Yt(r,e){return{customTitle:r,platformSource:e?M(e):void 0}}var W=class{db;constructor(e=ne()){e!==":memory:"&&Ie((0,$e.dirname)(e)),this.db=new ke.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns()}initializeSchema(){this.db.run(`
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=Yt(n,o),_=d.platformSource??O,m=this.db.prepare(`
