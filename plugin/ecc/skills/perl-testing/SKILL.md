---
name: perl-testing
description: "中文优先：用于Perl测试相关任务，帮助识别、设计、实现或验证对应工作流。English keywords: Perl testing patterns using Test2::V0, Test::More, prove runner, mocking, coverage with Devel::Cover, and TDD methodology."
origin: ECC
---
