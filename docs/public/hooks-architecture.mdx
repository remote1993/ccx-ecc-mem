...
This document describes an earlier Claude-Mem architecture centered on separate hook scripts such as `context-hook.js`, `new-hook.js`, `save-hook.js`, and `summary-hook.js`.
