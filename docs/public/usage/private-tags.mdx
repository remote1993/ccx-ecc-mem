...
Use `<private>` tags to mark content you don't want persisted in ccx-ecc-mem's observation database. This gives you fine-grained control over what gets remembered across sessions.
...
- Claude's responses (not captured by ccx-ecc-mem)
...
This is usually harmless - it indicates defensive type checking is working. However, if you see these frequently, it may indicate a bug. Please report it at https://github.com/remote1993/ccx-mem/issues
