...
function printHelp(): void {
  console.log(`
bug-report - Generate bug reports for ccx-ecc-mem
...
DESCRIPTION:
  ...
  and generates a formatted GitHub issue for ccx-ecc-mem using the Claude Agent SDK.
...
async function main() {
  ...
  console.log(`   ccx-ecc-mem: v${diagnostics.versions.claudeMem}`);
  ...
  const githubUrl = `https://github.com/remote1993/ccx-ecc-mem/issues/new?title=${encodedTitle}&body=${encodedBody}`;
