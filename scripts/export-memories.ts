 ...
 * Example: npx tsx scripts/export-memories.ts "windows" windows-memories.json --project=ccx-ecc-mem
 */
...
if (args.length < 2) {
  ...
  console.error('Example: npx tsx scripts/export-memories.ts "windows" windows-memories.json --project=ccx-ecc-mem');
