 ...
 * - CLI: `ccx-ecc-mem generate` / `ccx-ecc-mem clean`
...
import { getDbPath, getUserSettingsPath } from '../shared/paths.js';
...
function formatObservationsForClaudeMd(observations: ObservationRow[], folderPath: string): string {
  ...
  lines.push('');
  lines.push('<!-- This section is auto-generated by ccx-ecc-mem. Edit content outside the tags. -->');
  lines.push('');
...
function processAllFoldersForGeneration(
  ...
  const db = new Database(getDbPath(), { readonly: true, create: false });
