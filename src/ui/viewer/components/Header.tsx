...
function formatSourceLabel(source: string, labels: ViewerLabels): string {
  if (source === 'all') return labels.all;
  ...
  return (
    <div className="header">
      ...
      <div className="status">
        <a
          href="https://github.com/remote1993/ccx-mem"
          target="_blank"
        ...
        <GitHubStarsButton username="remote1993" repo="ccx-mem" />
        <select
          value={currentFilter}
